...
export function useFilmsListQuery(options?: Omit<Urql.UseQueryArgs<FilmsListQueryVariables>, 'query'>) {
  return Urql.useQuery<FilmsListQuery>({ query: FilmsListDocument, ...options });
};
